function [SVSLikertOut, Window]=SVSLikertH1(Space,ok,Window,ScreenRect,white,black,test, Index1, Index2)
...
text1_YouAreGoing3='In the paranthesis following each value is an explanation that may help you to understand its meaning.';
...
try
    ...
    for i=1:128
        if i==1
            ...
            SVSLikertOut.Properties.VariableNames{i}=strcat('H1_SVSLikert_',DimList_Out{i});
        elseif i<5
            SVSOuttemp=table(99);
            SVSOuttemp.Properties.VariableNames{1}=strcat('H1_SVSLikert_',DimList_Out{i});
            SVSLikertOut=[SVSLikertOut SVSOuttemp];
        elseif i<15
            SVSOuttemp=table(99);
            SVSOuttemp.Properties.VariableNames{1}=strcat('H1_SVSLikert_',ValList_Out{i-4});
            SVSLikertOut=[SVSLikertOut SVSOuttemp];
        elseif i<45
            SVSOuttemp=table(SVSLikertChoices(i-14));
            SVSOuttemp.Properties.VariableNames{1}=strcat('H1_SVSLikert_',ValueList1_Out{i-14});
            SVSLikertOut=[SVSLikertOut SVSOuttemp];
        elseif i<72
            SVSOuttemp=table(SVSLikertChoices(i-14));
            SVSOuttemp.Properties.VariableNames{1}=strcat('H1_SVSLikert_',ValueList2_Out{i-44});
            SVSLikertOut=[SVSLikertOut SVSOuttemp];
        elseif i<(72+length(Random1))
            SVSOuttemp=table(Random1(i-71));
            N=num2str(i-71);
            SVSOuttemp.Properties.VariableNames{1}=strcat('H1_SVSLikertSequence_',N);
            SVSLikertOut=[SVSLikertOut SVSOuttemp];
    ...
    if 5-DivCount > 0
        SVSLikertOut.H1_SVSLikert_PO(1)=sum(Temp)./(5-DivCount);
    end
    ...
    if 5-DivCount > 0
        SVSLikertOut.H1_SVSLikert_AC(1)=sum(Temp)./(5-DivCount);
    end
    ...
    if 3-DivCount > 0
        SVSLikertOut.H1_SVSLikert_HE(1)=(sum(Temp)./(3-DivCount));
    end
    ...
    if 3-DivCount > 0
        SVSLikertOut.H1_SVSLikert_ST(1)=(sum(Temp)./(3-DivCount));
    end
    ...
    if 7-DivCount > 0
        SVSLikertOut.H1_SVSLikert_SD(1)=sum(Temp)./(7-DivCount);
    end
    ...
    if 9-DivCount > 0
        SVSLikertOut.H1_SVSLikert_UN(1)=(sum(Temp)./(9-DivCount));
    end
    ...
    if 9-DivCount > 0
        SVSLikertOut.H1_SVSLikert_BE(1)=(sum(Temp)./(9-DivCount));
    end
    ...
    if 5-DivCount > 0
        SVSLikertOut.H1_SVSLikert_TR(1)=(sum(Temp)./(5-DivCount));
    end
    ...
    if 4-DivCount > 0
        SVSLikertOut.H1_SVSLikert_CO(1)=(sum(Temp)./(4-DivCount));
    end
    ...
    if 7-DivCount > 0
        SVSLikertOut.H1_SVSLikert_SE(1)=(sum(Temp)./(7-DivCount));
    end
    
    %Dimensions
    SVSLikertOut.H1_SVSLikert_Enhancement(1)=(SVSLikertOut.H1_SVSLikert_PO(1)+SVSLikertOut.H1_SVSLikert_AC(1))./2;
    SVSLikertOut.H1_SVSLikert_Openness(1)=(SVSLikertOut.H1_SVSLikert_HE(1)+SVSLikertOut.H1_SVSLikert_ST(1)+SVSLikertOut.H1_SVSLikert_SD(1))./3;
    SVSLikertOut.H1_SVSLikert_Transcendence(1)=(SVSLikertOut.H1_SVSLikert_UN(1)+SVSLikertOut.H1_SVSLikert_BE(1))./2;
    SVSLikertOut.H1_SVSLikert_Conservation(1)=(SVSLikertOut.H1_SVSLikert_CO(1)+SVSLikertOut.H1_SVSLikert_TR(1)+SVSLikertOut.H1_SVSLikert_SE(1))./3;
    ...
    if 57-DivCount > 0
        SVSLikertOut.H1_MRAT=sum(Temp)./(57-DivCount);
    end
    
    SVSLikertOut.H1_SVSLikert_POc(1)=SVSLikertOut{1,5}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_ACc(1)=SVSLikertOut{1,6}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_HEc(1)=SVSLikertOut{1,7}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_STc(1)=SVSLikertOut{1,8}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_SDc(1)=SVSLikertOut{1,9}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_UNc(1)=SVSLikertOut{1,10}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_BEc(1)=SVSLikertOut{1,11}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_TRc(1)=SVSLikertOut{1,12}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_COc(1)=SVSLikertOut{1,13}-SVSLikertOut{1,129};
    SVSLikertOut.H1_SVSLikert_SEc(1)=SVSLikertOut{1,14}-SVSLikertOut{1,129};
    
    SVSLikertOut.SVSLikert_Enhancementc(1)=SVSLikertOut{1,1}-SVSLikertOut{1,129};
    SVSLikertOut.SVSLikert_Opennessc(1)=SVSLikertOut{1,2}-SVSLikertOut{1,129};
    SVSLikertOut.SVSLikert_Transcendencec(1)=SVSLikertOut{1,3}-SVSLikertOut{1,129};
    SVSLikertOut.SVSLikert_Conservationc(1)=SVSLikertOut{1,4}-SVSLikertOut{1,129};
