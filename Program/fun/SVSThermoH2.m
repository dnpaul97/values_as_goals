function [SVSThermoOut,Window]=SVSThermoH2(Space,ok,Window,FlipInterval,OffWindow,ScreenRect,white,black,TimetoFillinSecs,test,Version,Index1,Index2)
...
text1_YouAreGoing='In this part of the study, we are examining a proposed new set of ideals to include in measures of values.';
...
text1_YourTask='Please respond to these new values in the same procedure as before.  Please ask yourself once more:\n"What values are important to YOU as guiding principles in YOUR life:"';
text1_YourTask1='Your will again see the rating scale below:';
...
try
    ...
    DrawFormattedText(Window, text1_YouAreGoing,'center',(ScreenRect(4)./100).*30, white,0,...
        0,0,3);
    Screen('TextSize', Window, (Size3+5));
    DrawFormattedText(Window, text1_YouAreGoing1,'center',(ScreenRect(4)./100).*37, white,0,...
        0,0,2);
    Screen('TextSize', Window, Size3+5);
    ...
    DrawFormattedText(Window, text1_YourTask,'center',(ScreenRect(4)./100).*15, white,0,...
        0,0,1.5 );
        ...
        while T1<T2
            ...
            for i=1:length(Random2)
                ...
                if i<(floor(length(Random2)./2))
                    ...
                    DrawFormattedText(Window, ValueList2_straight{Random2(i)-30},ScreenRect(3).*.53,(ScreenRect(4).*(.3+(.055*(i-floor(length(Random1)./2)))) ),...
                        white);
                end
            end
    ...
    for i=1:128
        if i==1
            ...
            SVSThermoOut.Properties.VariableNames{i}=strcat('H2_SVSThermo_',DimList_Out{i});
        elseif i<5
            SVSOuttemp=table(99);
            SVSOuttemp.Properties.VariableNames{1}=strcat('H2_SVSThermo_',DimList_Out{i});
            SVSThermoOut=[SVSThermoOut SVSOuttemp];
        elseif i<15
            SVSOuttemp=table(99);
            SVSOuttemp.Properties.VariableNames{1}=strcat('H2_SVSThermo_',ValList_Out{i-4});
            SVSThermoOut=[SVSThermoOut SVSOuttemp];
        elseif i<45
            SVSOuttemp=table(SVSThermoChoices(i-14));
            SVSOuttemp.Properties.VariableNames{1}=strcat('H2_SVSThermo_',ValueList1_Out{i-14});
            SVSThermoOut=[SVSThermoOut SVSOuttemp];
        elseif i<72
            SVSOuttemp=table(SVSThermoChoices(i-14));
            SVSOuttemp.Properties.VariableNames{1}=strcat('H2_SVSThermo_',ValueList2_Out{i-44});
            SVSThermoOut=[SVSThermoOut SVSOuttemp];
        elseif i<(72+length(Random1))
            SVSOuttemp=table(Random1(i-71));
            N=num2str(i-71);
            SVSOuttemp.Properties.VariableNames{1}=strcat('H2_SVSThermoSequence_',N);
            SVSThermoOut=[SVSThermoOut SVSOuttemp];
    ...
    if 5-DivCount > 0
        SVSThermoOut.H2_SVSThermo_PO(1)=sum(Temp)./(5-DivCount);
    end
    ...
    if 5-DivCount > 0
        SVSThermoOut.H2_SVSThermo_AC(1)=sum(Temp)./(5-DivCount);
    end
    ...
    if 3-DivCount > 0
        SVSThermoOut.H2_SVSThermo_HE(1)=(sum(Temp)./(3-DivCount));
    end
    ...
    if 3-DivCount > 0
        SVSThermoOut.H2_SVSThermo_ST(1)=(sum(Temp)./(3-DivCount));
    end
    ...
    if 7-DivCount > 0
        SVSThermoOut.H2_SVSThermo_SD(1)=sum(Temp)./(7-DivCount);
    end
    ...
    if 9-DivCount > 0
        SVSThermoOut.H2_SVSThermo_UN(1)=(sum(Temp)./(9-DivCount));
    end
    ...
    if 9-DivCount > 0
        SVSThermoOut.H2_SVSThermo_BE(1)=(sum(Temp)./(9-DivCount));
    end
    ...
    if 5-DivCount > 0
        SVSThermoOut.H2_SVSThermo_TR(1)=(sum(Temp)./(5-DivCount));
    end
    ...
    if 4-DivCount > 0
        SVSThermoOut.H2_SVSThermo_CO(1)=(sum(Temp)./(4-DivCount));
    end
    ...
    if 7-DivCount > 0
        SVSThermoOut.H2_SVSThermo_SE(1)=(sum(Temp)./(7-DivCount));
    end
    
    %Dimensions
    SVSThermoOut.H2_SVSThermo_Enhancement(1)=(SVSThermoOut.H2_SVSThermo_PO(1)+SVSThermoOut.H2_SVSThermo_AC(1))./2;
    SVSThermoOut.H2_SVSThermo_Openness(1)=(SVSThermoOut.H2_SVSThermo_HE(1)+SVSThermoOut.H2_SVSThermo_ST(1)+SVSThermoOut.H2_SVSThermo_SD(1))./3;
    SVSThermoOut.H2_SVSThermo_Transcendence(1)=(SVSThermoOut.H2_SVSThermo_UN(1)+SVSThermoOut.H2_SVSThermo_BE(1))./2;
    SVSThermoOut.H2_SVSThermo_Conservation(1)=(SVSThermoOut.H2_SVSThermo_CO(1)+SVSThermoOut.H2_SVSThermo_TR(1)+SVSThermoOut.H2_SVSThermo_SE(1))./3;
    ...
    if 57-DivCount > 0
        SVSThermoOut.H2_MRAT=sum(Temp)./(57-DivCount);
    end
    
    SVSThermoOut.H2_SVSThermo_POc(1)=SVSThermoOut{1,5}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_ACc(1)=SVSThermoOut{1,6}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_HEc(1)=SVSThermoOut{1,7}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_STc(1)=SVSThermoOut{1,8}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_SDc(1)=SVSThermoOut{1,9}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_UNc(1)=SVSThermoOut{1,10}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_BEc(1)=SVSThermoOut{1,11}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_TRc(1)=SVSThermoOut{1,12}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_COc(1)=SVSThermoOut{1,13}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_SEc(1)=SVSThermoOut{1,14}-SVSThermoOut{1,129};
    
    SVSThermoOut.H2_SVSThermo_Enhancementc(1)=SVSThermoOut{1,1}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_Opennessc(1)=SVSThermoOut{1,2}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_Transcendencec(1)=SVSThermoOut{1,3}-SVSThermoOut{1,129};
    SVSThermoOut.H2_SVSThermo_Conservationc(1)=SVSThermoOut{1,4}-SVSThermoOut{1,129};
